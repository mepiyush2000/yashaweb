...
const services = [
  ...
  },
  {
    ...
    title: "Group Therapy",
    description:
      "Connect with others in a supportive group setting to share experiences and learn together.",
    features: [
      "Peer support",
      "Shared experiences",
      "Group dynamics",
...
const pricing = [
  {
    ...
    price: "₹1,500",
    description: "60-minute session to discuss your needs",
  },
  {
    title: "Individual Session",
    price: "₹2,000",
    description: "50-minute one-on-one therapy session",
  },
  {
    title: "Couples/Family Session",
    price: "₹3,000",
    description: "60-minute session for couples or families",
  },
]; 